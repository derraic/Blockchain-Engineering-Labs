...
BLOCKCHAIN_COMMUNITY_ID_HEX = "24617269616E4A617972616E597665734C616233"
BLOCKCHAIN_COMMUNITY_ID = bytes.fromhex(BLOCKCHAIN_COMMUNITY_ID_HEX)

GROUP_ID = "d8c9d397bea2ee37"

ENABLE_SERVER_HANDLERS = True
ENABLE_TRANSACTION_BROADCAST = False

MINING_INTERVAL_SECONDS = 5.0
MINING_DIFFICULTY = 8
